...
def main() -> int:
    ...
    out_dir = cfg.out_root / "08_analysis"
    log_path = cfg.log_dir / "phase8.log"
    mp = out_dir / "manifest.json"
    ...
    _setup_log(log_path)
    logging.info("phase8 start stack=%s", a.stack)
    ...
    script = cfg.root / "scripts" / "oss" / "analyze.py"
    ...
    payload = {
        ...
        "outputs": {
            ...
            "comparative_rmsd": str(out_dir / "comparative_ligand_rmsd.png"),
            "comparative_rmsf": str(out_dir / "comparative_rmsf.png"),
            "hbond_means": str(out_dir / "hbond_means.png"),
        },
    }
