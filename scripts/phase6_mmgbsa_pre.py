...
def main() -> int:
    ...
    out_dir = cfg.out_root / "06_mmgbsa_pre"
    log_path = cfg.log_dir / "phase6.log"
    mp = out_dir / "manifest.json"
    ...
    _setup_log(log_path)
    logging.info("phase6 start stack=%s", a.stack)
    ...
    if a.stack == "schrodinger":
        ...
        _run(["bash", str(script),
              ...
              "--ligands", select_mf["outputs"]["leads_sdf"],
              "--out-dir", str(out_dir),
    ...
    payload = {
        ...
        "stack": a.stack,
        "outputs": {
            "csv": str(out_dir / "mmgbsa_pre.csv"),
        },
    }
